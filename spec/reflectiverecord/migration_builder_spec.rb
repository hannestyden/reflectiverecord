...
EOF
    ...
    it "needs to implement index support"
    # Need to read indexes from schema file
    # Then calculate differences in variation
    # Then build indexes in addition to column / table instructions
...
#       before(:each) { ActiveRecord::Base.instance_variable_set :@reflective_indexes, { :some_models => :title } }
